...
import 'package:fanspage/posts.dart';
import 'package:fanspage/register.dart';
...
class homepage extends StatefulWidget{
  ...
  @override
  State<homepage> createState() => _SignIn();
}

class _SignIn extends State<homepage>{
  bool _loading = false;
 ...
 // ignore: non_constant_identifier_names
  ...
  if (_formKey.currentState!.validate()){
    try {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const Posts()));
