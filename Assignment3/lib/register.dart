    ...
    return Scaffold (                     // Add from here... 
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            tooltip: 'go back',
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => const Login(title: '',)));
            },
          ),
      ),
  ...
  if (_formKey.currentState!.validate()){
    ...
    try {
      if (_auth.currentUser != null){
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(builder: ((context) => const Login(title: ''))));
      }
